...
#[derive(Debug)]
pub struct TurtleFormatContext {
    options: TurtleFormatOptions,
    comments: Rc<TurtleComments>,
    source_map: Option<TransformSourceMap>,
}

impl TurtleFormatContext {
    pub fn new(options: TurtleFormatOptions, comments: TurtleComments) -> Self {
        Self {
            options,
...
impl FormatContext for TurtleFormatContext {
    type Options = TurtleFormatOptions;
...
impl CstFormatContext for TurtleFormatContext {
    type Language = TurtleLanguage;
    type Style = TurtleCommentStyle;
    type CommentRule = FormatTurtleLeadingComment;

    fn comments(&self) -> &TurtleComments {
        &self.comments
    }
}
...
impl TurtleFormatOptions {
    pub fn new(file_source: TurtleFileSource) -> Self {
        Self {
...
impl fmt::Display for TurtleFormatOptions {
