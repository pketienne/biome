...
/// The variant of Turtle contained in the file.
#[cfg_attr(feature = "schema", derive(schemars::JsonSchema))]
#[derive(
    Debug, Clone, Default, Copy, Eq, PartialEq, Hash, serde::Serialize, serde::Deserialize,
)]
...
impl TurtleFileSource {
    pub fn turtle() -> Self {
        Self {
            variant: TurtleVariant::Standard,
        }
    }

    /// Try to return the Turtle file source corresponding to this file name from well-known files
    pub fn try_from_well_known(_: &Utf8Path) -> Result<Self, FileSourceError> {
        Err(FileSourceError::UnknownFileName)
    }

    /// Try to return the Turtle file source corresponding to this file extension
    pub fn try_from_extension(extension: &str) -> Result<Self, FileSourceError> {
        // We assume the file extension is normalized to lowercase
        match extension {
            "ttl" | "turtle" | "nt" => Ok(Self::default()),
            _ => Err(FileSourceError::UnknownExtension),
        }
    }

    /// Try to return the Turtle file source corresponding to this language ID
    ///
    ...
    pub fn try_from_language_id(language_id: &str) -> Result<Self, FileSourceError> {
        match language_id {
            "turtle" | "ntriples" => Ok(Self::default()),
            _ => Err(FileSourceError::UnknownLanguageId),
        }
    }
}

impl TryFrom<&Utf8Path> for TurtleFileSource {
