...
use biome_markdown_syntax::MdMdxJsxAttributeValue;
use biome_rowan::{AstNode, Direction, SyntaxElement};

#[derive(Debug, Clone, Default)]
pub(crate) struct FormatMdMdxJsxAttributeValue;

impl FormatNodeRule<MdMdxJsxAttributeValue> for FormatMdMdxJsxAttributeValue {
    fn fmt_fields(
        &self,
        node: &MdMdxJsxAttributeValue,
