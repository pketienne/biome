...
use biome_markdown_syntax::MdMdxJsxAttribute;
use biome_rowan::{AstNode, Direction, SyntaxElement};

#[derive(Debug, Clone, Default)]
pub(crate) struct FormatMdMdxJsxAttribute;

impl FormatNodeRule<MdMdxJsxAttribute> for FormatMdMdxJsxAttribute {
    fn fmt_fields(
        &self,
        node: &MdMdxJsxAttribute,
