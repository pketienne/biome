...
use biome_markdown_syntax::MdCheckbox;
use biome_rowan::{AstNode, Direction, SyntaxElement};

#[derive(Debug, Clone, Default)]
pub(crate) struct FormatMdCheckbox;

impl FormatNodeRule<MdCheckbox> for FormatMdCheckbox {
    fn fmt_fields(&self, node: &MdCheckbox, f: &mut MarkdownFormatter) -> FormatResult<()> {
