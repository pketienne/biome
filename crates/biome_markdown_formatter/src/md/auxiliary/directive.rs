...
pub(crate) struct FormatMdDirective;

impl FormatNodeRule<MdDirective> for FormatMdDirective {
    fn fmt_fields(&self, node: &MdDirective, f: &mut MarkdownFormatter) -> FormatResult<()> {
