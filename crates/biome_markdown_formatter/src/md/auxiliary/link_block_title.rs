...
use biome_markdown_syntax::MdLinkBlockTitle;
use biome_rowan::{AstNode, Direction, SyntaxElement};

#[derive(Debug, Clone, Default)]
pub(crate) struct FormatMdLinkBlockTitle;

impl FormatNodeRule<MdLinkBlockTitle> for FormatMdLinkBlockTitle {
    fn fmt_fields(
        &self,
        node: &MdLinkBlockTitle,
