...
use biome_markdown_syntax::MdDirectiveAttribute;
use biome_rowan::{AstNode, Direction, SyntaxElement};

#[derive(Debug, Clone, Default)]
pub(crate) struct FormatMdDirectiveAttribute;

impl FormatNodeRule<MdDirectiveAttribute> for FormatMdDirectiveAttribute {
    fn fmt_fields(
        &self,
        node: &MdDirectiveAttribute,
