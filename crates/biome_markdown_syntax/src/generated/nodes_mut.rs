...
impl MdBullet {
    ...
    pub fn with_checkbox(self, element: Option<MdCheckbox>) -> Self {
...
impl MdCheckbox {
    ...
    pub fn with_value_token(self, element: Option<SyntaxToken>) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl MdDirective {
    ...
    pub fn with_name(self, element: MdInlineItemList) -> Self {
        Self::unwrap_cast(
            self.syntax
    ...
    pub fn with_attributes(self, element: MdDirectiveAttributeList) -> Self {
        Self::unwrap_cast(
            self.syntax
...
impl MdDirectiveAttribute {
    ...
    pub fn with_eq_token(self, element: Option<SyntaxToken>) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(element.map(|element| element.into()))),
        )
    }
    pub fn with_value(self, element: Option<MdDirectiveAttributeValue>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MdDirectiveAttributeValue {
    pub fn with_delimiter_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into()))),
        )
    ...
    pub fn with_closing_delimiter_token(self, element: SyntaxToken) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into()))),
        )
...
impl MdFencedCodeBlock {
    ...
    pub fn with_language(self, element: MdInlineItemList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_meta(self, element: MdInlineItemList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MdLinkBlock {
    ...
    pub fn with_url(self, element: MdInlineItemList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(4usize..=4usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_title(self, element: Option<MdLinkBlockTitle>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            5usize..=5usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MdMdxJsxAttribute {
    ...
    pub fn with_value(self, element: Option<MdMdxJsxAttributeValue>) -> Self {
        Self::unwrap_cast(self.syntax.splice_slots(
            2usize..=2usize,
            once(element.map(|element| element.into_syntax().into())),
        ))
...
impl MdMdxJsxElement {
    ...
    pub fn with_attributes(self, element: MdMdxJsxAttributeList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MdTable {
    pub fn with_header(self, element: MdTableRow) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_separator(self, element: MdTableRow) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(1usize..=1usize, once(Some(element.into_syntax().into()))),
        )
    }
    pub fn with_rows(self, element: MdTableRowList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(2usize..=2usize, once(Some(element.into_syntax().into()))),
        )
...
impl MdTableRow {
    pub fn with_cells(self, element: MdTableCellList) -> Self {
        Self::unwrap_cast(
            self.syntax
                .splice_slots(0usize..=0usize, once(Some(element.into_syntax().into()))),
        )
