...
| 3 | [Code Duplication](#3-code-duplication) | Medium |
| 4 | [Error Handling](#4-error-handling) | High |
| 5 | [Performance](#5-performance) | Low |
| 6 | [Dependencies](#6-dependencies) | High |
| 7 | [Security](#7-security) | High |
| 8 | [Documentation](#8-documentation) | Medium |
| 9 | [Localization](#9-localization) | Medium |

### Standards conformance

| # | Category | Priority |
|---|----------|----------|
| 10 | [Project Standards](#10-project-standards) | Medium |

### Cross-cutting concerns

| ID | Concern | Role |
|----|---------|------|
| A | [Cross-Component Consistency](#a-cross-component-consistency) | Evaluation mode |
| B | [CI/CD Enforcement](#b-cicd-enforcement) | Enforcement layer |
...
|-------|-----------|------|
| 1 — Baseline | Test Coverage, Code Complexity, CI/CD maturity matrix | First audit |
| 2 — Risk reduction | Error Handling, Security, Dependencies | After baseline |
| 3 — Consistency | Code Duplication, Project Standards, Cross-Component check | After risk reduction |
| 4 — Polish | Documentation, Localization, Performance | After consistency |
